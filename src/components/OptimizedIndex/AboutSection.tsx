...
import ScrollReveal from '../ScrollReveal'; // ✅ Caminho corrigido
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            <ScrollReveal direction="left" delay={0.4} className="col-span-1 relative hidden lg:flex justify-center">
              <motion.div 
  ...
  return (
    ...
    >
      <motion.div
        ...
        style={{ background: `radial-gradient(circle at 50% 50%, ${glowColors[accent]}, transparent 70%)` }}
...
const contentBlocks = [
  {
    ...
    content: "Especialista em identificar pontos de inflexão onde a Inteligência Artificial pode gerar transformações exponenciais...",
    accent: "cyan" as const
  },
  {
    title: "Automação Cognitiva",
    content: "Desenvolvimento de ecossistemas inteligentes que não apenas automatizam processos, mas evoluem continuamente...",
    accent: "purple" as const
  },
  {
    title: "UX Conversacional Avançada",
    content: "Arquitetura de interfaces de diálogo que transcendem a interação tradicional...",
    accent: "gold" as const
  },
  {
    title: "Inteligência Preditiva",
    content: "Implementação de modelos de machine learning que antecipam tendências...",
    accent: "cyan" as const
  }
];
