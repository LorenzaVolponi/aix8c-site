...
export const AboutSection = lazy(() => import("@/components/OptimizedIndex/AboutSection"));
export const SobreNosSection = lazy(() => import("@/components/OptimizedIndex/SobreNosSection"));
