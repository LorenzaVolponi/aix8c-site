...
const ContentBlock = ({ 
  ...
  return (
    ...
    >
      ...
      <motion.div
        className={`absolute top-0 right-0 w-16 h-16 border-t-2 border-r-2 border-${accent === 'cyan' ? 'aix-cyan' : accent === 'purple' ? 'aix-purple' : 'aix-gold'}/30`}
        initial={{ scale: 0 }}
        whileInView={{ scale: 1 }}
