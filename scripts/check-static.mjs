...
for (const token of ['<title>', 'meta name="description"', 'id="contato"', 'id="volponi-stage"', 'id="fragmentos"', 'id="linguagem"', 'id="galeria"', 'id="simbolos"', 'href="/styles.css"', 'src="/main.js"']) {
